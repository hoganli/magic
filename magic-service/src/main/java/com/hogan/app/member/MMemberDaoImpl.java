...
/**
 * @ClassName MMemberDaoImpl
 * @Description memberDaoImpl自定义接口实现类
 * @author hoagn
 * @date 2019-05-24 17:15:32
 */
public class MMemberDaoImpl implements MMemberDaoCustom {
    ...
    public Page<MMember> findMMemberByCriteria(Map<String, Object> paramMap) throws Exception {
        ...
        CriteriaQuery<MMember> cq = cb.createQuery(MMember.class);
        Root<MMember> root = cq.from(MMember.class);
        ...
        // 获取查询实例（查询list和count）
        TypedQuery<MMember> typedQueryList = em.createQuery(cq);
        TypedQuery<MMember> typedQueryCount = em.createQuery(cq);
        ...
        // 构建返回对象
        return new PageImpl<MMember>(typedQueryList.getResultList(), pageable, typedQueryCount.getResultList().size());
    }
    ...
    public Page<MMember> findMMemberByJpql(Map<String, Object> paramMap) throws Exception {
      ...
      //复杂查询的Jpql语句设置
        StringBuilder sb = new StringBuilder("select t from MMember t where 1 = 1 ");
        ...
        TypedQuery<MMember> typedQueryList = em.createQuery(jpql, MMember.class);
        TypedQuery<MMember> typedQueryCount = em.createQuery(jpql, MMember.class);
    ...
    public  Page<MMember> findMMemberBySql(Map<String, Object> paramMap) throws Exception {
        ...
        //复杂查询的SQL语句设置
        StringBuilder sb = new StringBuilder("select * from m_member t where 1 = 1 ");
        ...
        Query queryList = em.createNativeQuery(sql, MMember.class);
        Query queryCount = em.createNativeQuery(sql, MMember.class);
        ...
        // 构建返回对象
        return new PageImpl<MMember>(queryList.getResultList(), pageable, queryCount.getResultList().size());
    }
}